...
class VisionTransformer(nn.Module):
    ...
    def __init__(
            ...
            mlp_ratio: float,
            in_channels: int = 3,
            image_w: int=None, # ADDED
            image_h: int=None, # ADDED
            patch_h: int=None, # ADDED
            patch_w: int=None, # ADDED
            ls_init_value: float = None,
        ...
        if image_w is not None and image_h is not None:
            image_height, image_width = image_h, image_w
        else:
            image_height, image_width = self.image_size = to_2tuple(image_size)
        if patch_h[0] is not None and patch_w[0] is not None:
            patch_height, patch_width = patch_h, patch_w
        else:
        ...
        self.conv1 = nn.Conv2d(
            ...
            out_channels=width,
            kernel_size=(patch_height, patch_width), # patch_size
            stride=(patch_height, patch_width), # patch_size
            bias=False,
        )
