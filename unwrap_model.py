...
"""
This script is used to unwrap the model from the training wrapper and 
save it as a standalone checkpoint that can be loaded without the training wrapper. 
This is useful for inference and for loading the model in other scripts 
without having to import the training wrapper.
"""
